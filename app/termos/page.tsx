      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-premium-navy-deep/50 shadow-lg rounded-lg p-8 space-y-8 border border-premium-gold/20">
          ...
          <section className="space-y-4">
            ...
            <p className="opacity-90">
              A organização do evento (MBRAS, Lamborghini São Paulo, Benx) preza pela segurança e bem-estar de todos os convidados, porém não se responsabiliza por acidentes ou incidentes que ocorram durante o evento que não sejam diretamente causados por negligência comprovada da organização.
            </p>
          </section>
